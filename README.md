# Retinalens-AI
I've built an Ai pipeline for the verification and detection of retina health via Analysis of Fundus Images (Images of the Inner side of the eye) in Diabetic Retinopathy. 
